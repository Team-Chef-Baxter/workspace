...
///
/// ikfast version 0x10000049 generated on 2024-11-01 21:17:39.398855
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
x45=(((x0*x29))+x31);
x46=((((-1.0)*x32))+((x0*x34)));
x47=(((x1*x15))+(((-1.0)*x0*x28)));
x48=((((-1.0)*x16*x8))+(((-1.0)*x15*x35)));
x49=(((x21*x4))+((x0*x2*x20)));
x50=(x1*x46);
x51=((((-1.0)*x35))+(((-1.0)*x15*x30)));
x52=(x45*x6);
x53=(x4*x48);
x54=((((-1.0)*x40))+x52);
x55=(((x10*x29))+((x4*x46)));
...
x57=(((x28*x7))+((x1*x48)));
x58=(x11*x56);
x59=(x38+x37+x42+x41+x14);
x60=(((x57*x9))+((x6*((x36+(((-1.0)*x15*x32)))))));
x61=(((x11*((x39+(((-1.0)*x53))))))+((x5*((((x57*x6))+((x44*x9)))))));
x62=(((x5*((x39+(((-1.0)*x53))))))+((x11*(((((-1.0)*x18*x44))+(((-1.0)*x27*x57)))))));
IkReal x64=((1.0)*x32);
x63=(((x1*(((((-0.01)*x30))+(((-1.0)*x0*x19*x3))))))+(((-1.0)*x24*x64))+((x19*x28))+(((0.37429)*x0*x10))+((x9*((((x20*x48))+((x22*x28))))))+(((-0.069)*x3*x7))+(((0.36442)*x10))+((x6*((((x0*x23))+(((-1.0)*x21*x64)))))));
eerot[0]=(((x12*x61))+((x13*(((((-1.0)*x25*x47))+(((-1.0)*x17*x54)))))));
eerot[1]=(((x12*x62))+((x13*(((((-1.0)*x17*x47))+(((-1.0)*x25*x56)))))));
eerot[2]=(((x12*x60))+((x13*(((((-1.0)*x27*x33))+(((-1.0)*x18*x45)))))));
eetrans[0]=((0.055695)+((x12*x63))+((x13*(((((-1.0)*x18*x49))+(((-1.0)*x59))))))+(((0.069)*x12)));
eerot[3]=(((x13*x61))+((x12*((((x11*x47))+((x5*x54)))))));
eerot[4]=(((x13*x62))+((x12*((((x47*x5))+x58)))));
eerot[5]=(((x13*x60))+((x12*((((x33*x6))+((x45*x9)))))));
eetrans[1]=(((x13*x63))+((x12*((((x49*x9))+x59))))+(((0.069)*x13)));
eerot[6]=(((x11*x55))+(((-1.0)*x5*((((x18*x51))+((x27*(((((-1.0)*x43))+x50)))))))));
eerot[7]=(((x11*((((x6*(((((-1.0)*x10*x28))+x50))))+((x51*x9))))))+((x5*x55)));
eerot[8]=(((x51*x6))+((x9*((x43+(((-1.0)*x50)))))));
IkReal x65=((1.0)*x30);
eetrans[2]=((0.281388)+(((0.01)*x10*x28))+(((-1.0)*x24*x65))+((x9*(((((-1.0)*x20*x46))+((x23*x28))))))+(((-0.37429)*x35))+((x1*((((x19*x8))+(((-1.0)*x26*x34))))))+(((-0.36442)*x7))+(((-0.069)*x34))+((x6*(((((-1.0)*x0*x22))+(((-1.0)*x21*x65)))))));
}
...
IkReal x66=IKsin(j10);
IkReal x67=IKcos(j10);
new_px=((-0.069)+(((-0.055695)*x67))+(((-0.254525)*r12*x66))+((px*x67))+((py*x66))+(((-0.254525)*r02*x67)));
new_r10=r21;
new_r11=((-1.0)*r20);
new_r12=((-1.0)*r22);
new_py=((0.281388)+(((0.254525)*r22))+(((-1.0)*pz)));
...
new_pz=((((-0.254525)*r12*x69))+(((0.254525)*r02*x68))+(((0.055695)*x68))+(((-1.0)*px*x68))+((py*x69)));
...
IKFAST_API const char* GetKinematicsHash() { return "5005bfcc10517ea805f75d0d119e374f"; }
